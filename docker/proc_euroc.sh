...
docker run --user usr \
    ...
    "~/proj/Examples/Monocular/mono_euroc ~/proj/Vocabulary/ORBvoc.txt ~/proj/Examples/Monocular/EuRoC.yaml /mnt/data/cam0/data && eval {mkdir,cd}\ /mnt/data/$(date +%Y-%m-%d-%H:%M:%S)\; && cp /tmp/*.yaml ."
